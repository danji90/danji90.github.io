...
describe('RouteSchedule', function () {
  beforeEach(function () {
    global.Date = jest.fn(function () { return ({
      getHours: function () {
        return 9;
      },
      getMinutes: function () {
  ...
  test('matches snapshots.', function () {
    ...
    var component = renderer.create(
      React.createElement( RouteSchedule, {
        lineInfos: lineInfos, trackerLayer: trackerLayer, setCenter: function () {}, renderHeaderButtons: function () { return React.createElement( 'div', null, "Button" ); } })
    );
