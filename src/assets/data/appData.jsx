...
const initialState = {
  ...
  articles: [
    {
      id: 'LBSNmobility',
      name: 'Using Data from Location Based Social Networks in Human Mobility Analysis (unpublished)',
    ...
    {
      id: 'perfnow',
      name: 'performance.now() 2024',
      url: 'https://geops.com/en/blog/performance-now-2024',
    },
  ],
  workItems: [
    {
